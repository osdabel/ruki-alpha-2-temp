...
import VisiRUKI from "@/components/VisiRUKI.jsx";
...
export default function Home() {
  ...
  return (
    <>
    <main className="w-screen h-108 bg-blue-700 text-white rounded-br-4xl px-4 pt-10 relative z-10 top-0 left-0">
      <div className="">
        <h6>RUKI</h6>
        <IntroText />
        <h2 className="text-sm font-light mt-10">RUKI mewujudkan platform untuk berkreasi, menciptakan ekosistem informasi yang terintegrasi. Menjadi pionir digitalisasi, dan menginspirasi untuk berinovasi</h2>
      </div>
