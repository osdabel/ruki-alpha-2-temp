            ...
            <div className="mt-10 w-full h-max flex justify-between">
                <div>
                    ...
                    <ul className="list-none opacity-50">
                        ...
                        <li className="mb-4">MPK</li>
                        <li className="mb-4">MPLS</li>
                        <li className="mb-4">AKSI SISWA</li>
                        <li className="mb-4">Song Req</li>
                ...
                <div>
                    ...
                    <ul className="list-none opacity-50">
                        <li className="mb-4 mt-4">Teh Eco</li>
                        <li className="mb-4">Bagja Design Printing</li>
                        <li className="mb-4">Garut Souvenir</li>
                    </ul>
                </div>
            </div>
